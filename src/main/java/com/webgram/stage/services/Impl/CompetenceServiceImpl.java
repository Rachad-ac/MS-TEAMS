...
public class CompetenceServiceImpl implements CompetenceService {
    ...
    public CompetenceDTO updateCompetence(CompetenceDTO competenceDTO) {
        var entityUpdate = competenceMapper.asEntity(competenceDTO);
        var updatedEntity = competenceRepository.save(entityUpdate);
    ...
    private void buildSearch(Map<String, String> searchParams, BooleanBuilder booleanBuilder) {
        if (Objects.nonNull(searchParams)) {
            ...
            if (searchParams.containsKey("nom_competence"))
                booleanBuilder.and(qEntity.nom.containsIgnoreCase(searchParams.get("nom_competence")));
